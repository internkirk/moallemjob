...
<div class="page-header">
    ...
    <div class="d-flex">
        {{-- <div class="justify-content-center">
            <a href="{{route('panel.users.create')}}" type="button" class="btn btn-primary my-2 btn-icon-text">
                ایجاد ادمین
            </a>
        </div> --}}
    </div>
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive userlist-table">
                    <table class="table card-table table-striped table-vcenter text-nowrap mb-0" id="usersTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    <a href="{{route('panel.users.edit',$user->id)}}" class="btn btn-sm btn-info">
                                        <i class="fe fe-edit-2"></i>
                                    </a>
                                    <form action="{{route('panel.users.delete')}}" method="POST"
