...
@section('title' , 'ایجاد شغل درخواستی')
...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ایجاد درخواست</h2>
        <ol class="breadcrumb">
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            <div class="card-body">
                <form action="{{route('panel.teacher.job.in.demand.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_pre_school" type="checkbox"> <span>پیش دبستانی
                                </span></label>
                        </div>
                        @error('is_pre_school')
                        <ui>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_elementary" type="checkbox">
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_middle_school" type="checkbox"> <span> متوسطه اول
                                </span></label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_high_school" type="checkbox"> <span>متوسطه
                                    نظری</span></label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_techinical_college" type="checkbox">
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_foreign_lan_teacher" type="checkbox"> <span>مدرس زبان
                                    خارجی</span></label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_entrance_exam_teacher" type="checkbox"> <span>مدرس
                                    کنکور</span></label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_academic_counsellor" type="checkbox"> <span>مشاور
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_honar_amouz" type="checkbox">
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_full_time" type="checkbox"> <span>تمام
                                    وقت</span></label>
                        </div>
                        @error('is_full_time')
                        <ui>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_half_time" type="checkbox"> <span>نیمه
                                    وقت</span></label>
                        </div>
                        @error('is_half_time')
                        <ui>
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_part_time" type="checkbox"> <span>پاره
                                    وقت</span></label>
                        </div>
                        @error('is_part_time')
                        <ui>
