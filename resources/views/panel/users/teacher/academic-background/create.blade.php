...
@section('title' , 'ایجاد سابقه تحصیلی')
...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ایجاد سابقه تحصیلی</h2>
        <ol class="breadcrumb">
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.teacher.academic.background.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="teacher_id" value="{{$teacher->id}}">
                    <div class="form-group">
                        <p class="mg-b-10">مقطع تحصیلی</p>
                        <div class="col-lg-4 col-xl-3 my-3">
                            <label class="ckbox"><input name="is_high_school" type="checkbox"> <span>متوسطه </span></label>
                        </div>
                        <div class="col-lg-4 col-xl-3 my-3">
                            <label class="ckbox"><input name="is_associate" type="checkbox"> <span>کاردانی </span></label>
                        </div>
                        <div class="col-lg-4 col-xl-3 my-3">
                            <label class="ckbox"><input name="is_bachelor" type="checkbox"> <span>کارشناسی </span></label>
                        </div>
                        <div class="col-lg-4 col-xl-3 my-3">
                            <label class="ckbox"><input name="is_master" type="checkbox"> <span>کارشناسی ارشد </span></label>
                        </div>
                        <div class="col-lg-4 col-xl-3 my-3">
                            <label class="ckbox"><input name="is_phd" type="checkbox"> <span>دکترا و بالاتر </span></label>
                        </div>
                    </div>
                    <div class="form-group">
