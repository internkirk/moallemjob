...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ایجاد معلم</h2>
        <ol class="breadcrumb">
                ...
                <form action="{{route('panel.teacher.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_male" type="checkbox"> <span>مرد </span></label>
                        </div>
                        @error('is_male')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_single" type="checkbox"> <span>مجرد </span></label>
                        </div>
                        @error('is_single')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <label class="ckbox"><input name="is_selected" type="checkbox"> <span>دارد </span></label>
                        </div>
                        @error('is_selected')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
