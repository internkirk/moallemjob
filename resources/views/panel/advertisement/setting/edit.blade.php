...
@section('title' , 'ویرایش عنوان رشته')
...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ویرایش عنوان رشته</h2>
        <ol class="breadcrumb">
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.major.update',$major->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <p class="mg-b-10">عنوان رشته</p>
                        <input type="text" class="form-control" name="title" value="{{$major->title}}">
                        @error('title')
                        <ui>
