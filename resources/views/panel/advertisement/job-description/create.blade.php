...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            <div class="card-body">
                <form action="{{route('panel.advertisement.job.description.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="job_description" rows="10" cols="10"></textarea>
