...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ایجاد آموزشگاه</h2>
        <ol class="breadcrumb">
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.academy.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3 d-flex gap-5">
                            <div>
                                <label class="chbox"><input name="is_prime_academy"  type="checkbox" value="true" > <span>فعال</span></label>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="students_number">
...
<script>
    $(document).ready(function(){
        $('#addRow').click(function(){
            $('#academy_level').append(
                `
                <hr>
                <div class="form-group">
                            <p class="mg-b-10">مقطع تحصیلی</p>
                            <input type="text" class="form-control" name="academy_level_title[]">
                            @error('academy_level_title[]')
                            <ui>
                                <li class="alert alert-danger">{{$message}}</li>
                            </ui>
                            @enderror
