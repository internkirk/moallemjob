...
<div class="page-header">
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> <a href="{{route('panel.prime.academy.requests.index')}}">
                    لیست درخواست ها
                </a>
            </li>
    ...
    <div class="d-flex">
        <div class="justify-content-center">
            <a href="{{route('panel.prime.academy.requests.index')}}" type="button"
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.prime.academy.requests.update',$request->id)}}" method="POST"
