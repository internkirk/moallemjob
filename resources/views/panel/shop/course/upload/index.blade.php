...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">آپلود ویدئو</h2>
        <ol class="breadcrumb">
    ...
    <div class="d-flex">
        <div class="justify-content-center">
            <a href="{{route('panel.shop.course.episode.index',$episode->course_id)}}" type="button" class="btn btn-primary my-2 btn-icon-text">
                بازگشت
            </a>
        </div>
    </div>
...
url: '{{ route("panel.shop.course.episode.upload.video.store") }}',
    method: 'post',
    chunking: true,
    forceChunking: true,
    chunkSize: 20 * 1024 * 1024, // 20 MB chunks
    dictDefaultMessage: 'لطفا ویدئو خود را وارد کنید',
    thumbnailWidth: 120,
    thumbnailHeight: 120,
...
{{-- <script>
    setTimeout(() => {
        ...
        let btn = document.querySelector('.dz-button')
        console.log(btn);
        
        btn.innerHTML = 'لطفا یک فایل را وارد کنید'
    },1000);
</script> --}}
@endsection