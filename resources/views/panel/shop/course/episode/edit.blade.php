...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ویرایش دوره</h2>
        <ol class="breadcrumb">
    ...
    <div class="d-flex">
        <div class="justify-content-center">
            <a href="{{route('panel.shop.course.episode.index',$episode->course_id)}}" type="button" class="btn btn-primary btn-icon-text my-2 me-2">
                بازگشت
            </a>
        </div>
    </div>
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.shop.course.episode.update',$episode->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="course_id" value="{{$episode->course_id}}">
                    ...
                    <div class="form-group">
                        <p class="mg-b-10">وضعیت اپیزود</p>
                        <div class="col-lg-4 col-xl-3 d-flex gap-5">
                            <div>
                                <label class="rdiobox"><input name="status" @if($episode->status) checked @endif type="radio" value="true"> <span>قابل
                                        نمایش</span></label>
                            </div>
                            <div>
                                <label class="rdiobox"><input name="status" @if(!$episode->status) checked @endif type="radio" value="false">
                    ...
                    <div class="form-group mb-5">
                        <p class="mg-b-10">مدت زمان اپیزود </p>
                        <input type="text" class="form-control" name="duration" value="{{$episode->duration}}">
                        @error('duration')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                        </ui>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div>
                            <img src="{{json_decode($episode->thumbnail,true)[0]}}" width="250px" height="250px" alt="">
                        </div>
                        @error('thumbnail')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="description" hidden
                                id="description_textarea_description_for_edit">{{$episode->description}}</textarea>
                        </div>
                        @error('description')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="short_description" hidden
                                id="description_textarea_short_description_for_edit">{{$episode->short_description}}</textarea>
                        </div>
