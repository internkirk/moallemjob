...
<div class="page-header">
    ...
    <div class="d-flex">
        <div class="justify-content-center">
            <a href="{{route('panel.shop.course.index')}}" type="button" class="btn btn-primary btn-icon-text my-2 me-2">
                بازگشت
            </a>
        </div>
    </div>
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.shop.course.update',$course->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="d-flex gap-2 mb-3">
                            ...
                            <input type="text" id="slug_input" class="form-control col-5" placeholder="کلید را وارد کنید...">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3 d-flex gap-5">
                            <div>
                                <label class="rdiobox"><input name="status" @if($course->status) checked @endif type="radio" value="true"> <span>قابل
                                        نمایش</span></label>
                            </div>
                            <div>
                                <label class="rdiobox"><input name="status" @if(!$course->status) checked @endif type="radio" value="false">
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div>
                            <img src="{{json_decode($course->thumbnail,true)[0]}}" width="250px" height="250px" alt="">
                        </div>
                        @error('thumbnail')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="description" hidden
                                id="description_textarea_description_for_edit">{{$course->description}}</textarea>
                        </div>
                        @error('description')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <!--    <div id="quillEditor2"></div>-->
                            <textarea name="short_description" class="form-control" rows="10" cols="10"
                                id="description_textarea_short_description_for_edit">{{$course->short_description}}</textarea>
                        </div>
