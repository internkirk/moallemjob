...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.shop.product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                            ...
                            <select class="form-control select2" multiple name="slug[]" id="slug_select">
                                @foreach (json_decode($product->slug) as $key => $slug )
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-xl-3 d-flex gap-5">
                            <div>
                                <label class="rdiobox"><input name="status" @if($product->status) checked @endif type="radio" value="true"> <span>قابل
                                        نمایش</span></label>
                            </div>
                            <div>
                                <label class="rdiobox"><input name="status" @if(!$product->status) checked @endif type="radio" value="false">
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div>
                            <img src="{{json_decode($product->thumbnail,true)[0]}}" width="250px" height="250px" alt="">
                        </div>
                        @error('thumbnail')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="description" hidden
                                id="description_textarea_description_for_edit">{{$product->description}}</textarea>
                        </div>
                        @error('description')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <!--    <div id="quillEditor2"></div>-->
                            <textarea name="short_description"  class="form-control" rows="10" cols="10"
                                id="description_textarea_short_description_for_edit">{{$product->short_description}}</textarea>
                        </div>
