...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">ویرایش تنظیمات</h2>
        <ol class="breadcrumb">
...
<div class="row row-sm">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{route('panel.setting.update',$setting->id)}}" method="POST"
                    ...
                    <div class="form-group mb-5">
                        ...
                        <textarea type="text" class="form-control" name="enamad" rows="6">{{$setting->enamad}}</textarea>
                        @error('enamad')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                        </ui>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="col-sm-6 col-md-6 mt-lg-0 mt-3">
                            <img src="{{json_decode($setting?->logo,true)[0]}}" width="250px" height="250px" alt="">
                        </div>
                        @error('logo')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="contact_us" hidden id="description_textarea_contact_us_for_edit">{{$setting->contact_us}}</textarea>
                        </div>
                        @error('contact_us')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="ql-wrapper ql-wrapper-demo">
                            ...
                            <textarea name="about_us" hidden id="description_textarea_about_us_for_edit">{{$setting->about_us}}</textarea>
                        </div>
                        @error('about_us')
                        <ui>
                            <li class="alert alert-danger">{{$message}}</li>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div id="questions">
                            @if (is_array(json_decode($setting->questions,true)))
                            @foreach (json_decode($setting->questions,true) as $question => $answer)
                            <hr>
                            <div class="form-group">
                                <p class="mg-b-10">عنوان سوال</p>
                                <input type="text" class="form-control" name="question_title[]" value="{{$question}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" cols="10" rows="10" name="question_answer[]">{{$answer}}</textarea>
