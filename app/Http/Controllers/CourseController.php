...
class CourseController extends Controller
{
    ...
    {
        $courses = Course::all();
        return view('panel.shop.course.index', compact('courses'));
    }
    public function create()
    {
        $categories = CourseCategory::all();
        return view('panel.shop.course.create',compact('categories'));
    }
    public function store(Request $request)
    {
        ...
        if ($request->file('thumbnail')) {
            $this->saveImages($request, $course->id);
        }

        return redirect()->route('panel.shop.course.index')->with([
    ...
    public function edit($id)
    {
        ...
        $categories = CourseCategory::all();
        return view('panel.shop.course.edit', compact('course','categories'));
    }
    ...
    public function delete(Request $request)
    {
        ...
        Storage::disk('public')->deleteDirectory("/course/thumbnail/image/" . $request->id);
    ...
    private function saveImages(Request $request, $id)
    {
        ...
        Storage::disk('public')->deleteDirectory("/course/thumbnail/image/" . $id);

        Storage::disk('public')->makeDirectory('/course/thumbnail/image/');
        $path[] = "/storage/" . Storage::disk('public')->put("/course/thumbnail/image/" . $id, $request->thumbnail);
